...
//==========================================================================================
// build.h
// Build Information, automatically generated on 08/02/13 15:32:49.  
...
const char  device_id_string[] = "UCD3100ISO1" "|" "0" "." "0" "." "11" "." "0" "272" "|" "130802";
...
int pmbus_read_device_id(void)
{
    ...
    string_len = (((sizeof(device_id_string))>((32))) ? ((32)):(sizeof(device_id_string)));
