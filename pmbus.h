...
#define SETUP_ID            "VERSION1|PSFB000"			//Generic setup id

#define DEVICE           	 UCD3100ISO1  				//Device Name
#define MFR_ID				"TI"						//Hardware Manufacturer
#define MFR_MODEL			"UCD3138ITTFEVM-562"			//Hardware Model
#define MFR_REVISION    	"E1"						//Hardware revision
#define MFR_DATE			"131020"
#define MFR_LOCATION		"Dallas, TX"
#define MFR_SERIAL			"XXXXX"
#define MFR_IC_DEVICE		"UCD3138RGC"
#define MFR_IC_DEVICE_REV	"0"
