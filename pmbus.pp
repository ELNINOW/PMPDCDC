...
Uint8 pmbus_read_frequency(void)
{
	pmbus_read_two_byte_handler((140));
...
Uint8 pmbus_write_vout_ov_fault_limit(void)
{
	...
	pmbus_dcdc_config_translated[0].vout_ov_fault_limit = ((Uint32)pmbus_dcdc_config[0].vout_ov_fault_limit * ((Uint32)((0.026 * 10) * 4096 / 2.5))) >> ((9) + 5);
...
Uint8 pmbus_write_iout_oc_fault_limit(void)
{
	...
	pmbus_dcdc_config_translated[0].iout_oc_fault_limit = (linear11_translation(pmbus_dcdc_config[0].iout_oc_fault_limit, 0) * ((Uint32)((0.24) * 4096 / 2.5))) >> 5;
...
int32 pmbus_read_message(void)
{
	switch (pmbus_buffer[0]) 			
	{
		...
		case 0x95: 
			return pmbus_read_two_byte_handler((140));	
        case 0xE5: 
