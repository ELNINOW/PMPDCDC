...
const Uint8 setup_id[]          = "VERSION1|PSFB000";
const Uint8 mfr_id[]			= "TI";
const Uint8 mfr_model[]			= "UCD3138ITTFEVM-562";
const Uint8 mfr_revision[]		= "E1";
const Uint8 mfr_date[]			= "131020";
...
void send_string(const Uint8 string_to_send[], Uint8 num_bytes)
{
	...
	string_len = (Uint8) (((num_bytes)>(40 - 1)) ? (40 - 1):(num_bytes));
...
int pmbus_read_setup_id(void) 
{
	send_string(setup_id, (Uint8) sizeof("VERSION1|PSFB000"));
	return (0);
}

int pmbus_mfr_model_handler(void) 
{ 
	send_string(mfr_model, (Uint8) sizeof("UCD3138ITTFEVM-562"));
	return (0);
}

int pmbus_mfr_revision_handler(void) 
{ 
	send_string(mfr_revision, (Uint8) sizeof("E1"));
	return (0);
}
...
int pmbus_mfr_date_handler(void) 
{ 
	send_string(mfr_date, (Uint8) sizeof("131020"));
	return (0);
}
